...
TEST(vulkan, bufferMagicGuards)
{
	...
	for (size_t k = 0; k < devices.size(); ++k) {
		...
		std::vector<unsigned int> ns = {1, 2, 3, 4, 5, 6, 7, 8, 15, 16, 17, 31, 32, 33, 63, 64, 65, 127, 128, 129, 255, 256, 257, 511, 512, 513, 128*1024*1024-1, 128*1024*1024, 128*1024*1024+1};
